...
if(!base.includes("background:var(--v14-paper)")||!base.includes("v14-foundation"))fail("light/dark V14 rhythm missing");
...
if(base.includes("images.unsplash.com"))fail("V14 public visual layer depends on stock background");
...
console.log("VISUAL_V14_PASS hero=PRODUCT_STAGE mobile=DEDICATED rhythm=LIGHT_DARK search-education=PASS og=FIRST_PARTY trust=PASS portfolio=VISUAL stock=ABSENT heavy-3d=ABSENT");

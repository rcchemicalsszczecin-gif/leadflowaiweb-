...
const publicSources=["app/page.tsx","app/o-nas/page.tsx","app/uslugi/page.tsx","app/kontakt/page.tsx","app/realizacje/page.tsx","app/wiedza/page.tsx","app/wiedza/[slug]/page.tsx","app/lab/page.tsx","app/local-seo/page.tsx","components/v14-hero.tsx","components/v14-browser-mockup.tsx","components/v14-phone-mockup.tsx","components/v14-services.tsx","components/v14-device-theater.tsx","components/v14-liquid-constructor.tsx","components/v14-search-trinity.tsx","components/v14-process-canvas.tsx","components/v14-portfolio.tsx","components/v14-knowledge-faq.tsx","components/v14-contact-brief.tsx","components/v14-closing.tsx","components/audience-paths-v13.tsx","components/contact-brief-builder-v13.tsx","components/offer-levels-v13.tsx","components/search-visibility-explainer-v13.tsx","components/interactive-experience.tsx","components/portfolio-project-visual.tsx","components/site-header.tsx","components/site-footer.tsx","components/service-page.tsx","lib/site.ts"];
...
for(const required of ["LEADFLOWAI","pracują jak produkt","Wyceń projekt","Zobacz realizacje","MOBILE FIRST","/v14-content.css"])if(!hero.includes(required))fail(`V14 hero missing public/shell label: ${required}`);
...
console.log(`PUBLIC_LANGUAGE_V14_PASS sources=${publicSources.length} retired=${retired.length} glossary=AUTHORITATIVE homepage-content=PASS knowledge=PASS faq=PASS brief=FRONTEND_ONLY liquid=PASS trinity=PASS process=PASS portfolio=FIRST_PARTY closing=PASS trust=PL`);
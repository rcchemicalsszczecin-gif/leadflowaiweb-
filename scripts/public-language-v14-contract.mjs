...
const publicSources=["app/page.tsx","app/o-nas/page.tsx","app/uslugi/page.tsx","app/kontakt/page.tsx","app/realizacje/page.tsx","app/wiedza/page.tsx","app/wiedza/[slug]/page.tsx","app/lab/page.tsx","app/local-seo/page.tsx","components/v14-hero.tsx","components/v14-browser-mockup.tsx","components/v14-phone-mockup.tsx","components/audience-paths-v13.tsx","components/contact-brief-builder-v13.tsx","components/offer-levels-v13.tsx","components/search-visibility-explainer-v13.tsx","components/interactive-experience.tsx","components/portfolio-project-visual.tsx","components/site-header.tsx","components/site-footer.tsx","components/service-page.tsx","lib/site.ts"];
...
for(const required of ["V14 / VISUAL REBUILD","Search + AI","Chatboty / RAG"])if(!home.includes(required))fail(`V14 homepage missing public label: ${required}`);
...
console.log(`PUBLIC_LANGUAGE_V14_PASS sources=${publicSources.length} retired=${retired.length} glossary=AUTHORITATIVE homepage=V14_BUYER_FIRST_PL trust=PL`);

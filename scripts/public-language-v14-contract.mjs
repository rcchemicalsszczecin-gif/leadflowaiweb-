...
for(const required of ["V14Hero","V14Services","V14DeviceTheater","V14LiquidConstructor"])if(!home.includes(required))fail(`V14 homepage composition missing: ${required}`);
...
console.log(`PUBLIC_LANGUAGE_V14_PASS sources=${publicSources.length} retired=${retired.length} glossary=AUTHORITATIVE homepage=V14_PRODUCT_PL liquid=PASS trust=PL`);

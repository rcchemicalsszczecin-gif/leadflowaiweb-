...
export const metadata = getExpandedServiceMetadata("integracje-ai");
export default function Page() { return <PublicServicePage page={getExpandedServicePage("integracje-ai")} />; }

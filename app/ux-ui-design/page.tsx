...
export const metadata = getExpandedServiceMetadata("ux-ui-design");
export default function Page() { return <PublicServicePage page={getExpandedServicePage("ux-ui-design")} />; }

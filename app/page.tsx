...
const faqs = [
  ...
  {
    question: "Czy Averiq robi tylko nowe strony?",
    answer:
        ...
        <div className="page-shell">
          ...
          <div className="hero-grid">
            <div className="hero-copy">
              <p className="eyebrow">AVERIQ / WEB ENGINEERING</p>
              <h1 id="hero-title">
                Strony internetowe
        ...
        <div className="page-shell section-pad">
          ...
          <ol className="process-list">
            <li>
              ...
              <p>Cel, odbiorca, obecna strona, konkurencja, wymagania i mierzalny rezultat.</p>
            </li>
            <li>
              <span>02</span>
              <strong>Architektura</strong>
              <p>Informacja, UX, search architecture, treść, dane i plan konwersji.</p>
            </li>
            <li>
              <span>03</span>
              <strong>Design + build</strong>
              <p>Interfejs, komponenty, responsive, development i integracje.</p>
            </li>
            <li>
              <span>04</span>
              <strong>Validation</strong>
              <p>Funkcje, mobile, accessibility, SEO/AEO/GEO, performance i security.</p>
            </li>
            <li>
              <span>05</span>
              <strong>Launch + growth</strong>
              <p>Publikacja, monitoring, pomiar i rozwój na podstawie rzeczywistych danych.</p>
            </li>
          </ol>
        </div>
      </section>
        ...
        <div className="page-shell section-pad proof-grid">
          ...
          <div className="proof-copy">
            <p>
              ...
              Kolejne case studies pojawią się wraz z rzeczywistymi wdrożeniami Averiq i
      ...
      <section id="contact" className="contact-section section-dark">
        <div className="page-shell contact-grid">
          ...
          <div className="contact-actions">
            ...
            <p>
              Strony WWW · Landing pages · E-commerce · SEO · AEO · GEO · Chatboty · Integracje
            </p>
          </div>
        </div>

...
export const metadata: Metadata = {
  ...
  description: "Pełny katalog usług LeadFlowAI: strony i aplikacje webowe, 3D/WebGL, SEO/AEO/GEO, CRO, analityka, AI, integracje, automatyzacje, WCAG, performance, bezpieczeństwo i utrzymanie.",
...
const pillars = [
  ...
  { key: "INTELLIGENCE", title: "Inteligencja", description: "Chatboty, RAG i integracje AI z jasno określoną rolą, źródłami wiedzy, guardrails i fallbackiem." },
  ...
  { key: "CARE", title: "Jakość, bezpieczeństwo i utrzymanie", description: "Core Web Vitals, WCAG, security, hosting, deployment, monitoring, backup i dalszy rozwój." },
] as const;
    ...
    <main className="service-page">
        ...
        <div className="page-shell">
          ...
          <div className="service-hero-grid">
            <div className="service-hero-copy">
              ...
              <p className="service-lead">Nie ograniczamy się do wykonania strony. Możemy zaprojektować produkt, widoczność, konwersję, AI, integracje i warstwę utrzymania jako jeden spójny system albo wejść tylko w potrzebny moduł.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-dark portfolio-method">
        <div className="page-shell section-pad">
          ...
          <p>Nowa strona może zacząć się od architektury i developmentu. Istniejący serwis może potrzebować tylko audytu, CRO, performance, WCAG, SEO/AEO/GEO albo integracji. Moduły są projektowane tak, aby mogły później tworzyć większy system bez przepisywania wszystkiego od początku.</p>
        </div>
